...
// +kubebuilder:rbac:groups=cleaner.cloudclub.dev,resources=cleanpolicies,verbs=get;list;watch;create;update;patch;delete
...
// the CleanPolicy object against the actual cluster state, and then
